...
public class Modelheart<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "heart"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(10, 17)
						.addBox(-0.9375F, -3.3125F, 3.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 7)
		...
		PartDefinition Rightarm = partdefinition.addOrReplaceChild("Rightarm",
				CubeListBuilder.create().texOffs(15, 14).addBox(0.0F, -0.5F, -0.5F, 0.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 16.5F, 1.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition Leftarm = partdefinition.addOrReplaceChild("Leftarm", CubeListBuilder.create(),
				PartPose.offset(4.9F, 16.5F, 1.0F));

		PartDefinition cube_r1 = Leftarm
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(4, 13).addBox(0.0F, -0.5F, -0.5F, 0.0F, 5.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition Rightleg = partdefinition.addOrReplaceChild("Rightleg",
				CubeListBuilder.create().texOffs(8, 18)
						.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(6, 0)
						.addBox(-0.5F, 5.0F, -1.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 19.0F, 1.0F));

		PartDefinition Leftleg = partdefinition.addOrReplaceChild("Leftleg",
				CubeListBuilder.create().texOffs(6, 18)
						.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(2, 0)
						.addBox(-0.5F, 5.0F, -1.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.5F, 19.0F, 1.0F));

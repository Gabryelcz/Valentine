...
public class Modelmonsterheart<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("valentines_day", "modelmonsterheart"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Rightleg = partdefinition.addOrReplaceChild("Rightleg",
				CubeListBuilder.create().texOffs(20, 37).addBox(-0.5F, -0.75F, -0.5F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.5F, 16.75F, -0.5F));
		PartDefinition Leftleg = partdefinition.addOrReplaceChild("Leftleg",
				CubeListBuilder.create().texOffs(16, 37).addBox(-0.5F, -0.75F, -0.5F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 16.75F, -0.5F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, 0.0F, -2.0F, 10.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 19)
		...
		PartDefinition Rightarm = partdefinition.addOrReplaceChild("Rightarm",
				CubeListBuilder.create().texOffs(0, 33).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 14.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-8.5F, 8.0F, -0.5F));
		PartDefinition Leftarm = partdefinition.addOrReplaceChild("Leftarm",
				CubeListBuilder.create().texOffs(24, 29).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 14.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.5F, 8.0F, -0.5F));
